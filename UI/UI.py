...
class SecondWindow(QDialog):
    ...
    def initUI(self):
        ...
        self.inform_Car = QLabel('Car (ADAS)',self)
        self.inform_Server = QLabel('Server',self)

        self.inform_Driver.move(250, 40)
        self.inform_Car.move(860, 40)
        self.inform_Server.move(1550, 40)
        ...
        # set Server video to main UI
        self.Server_label = QLabel(self)
        self.Server_label.setStyleSheet("background : black;")
        self.Server_label.resize(550, 450)
        self.Server_label.move(1300, 100)
        ...
        self.inform_Server.setFont(font)
        self.textCar_label.setFont(font)
        self.myCarNumber_label.setFont(font)

        # Set styles for labels
        self.inform_Driver.setStyleSheet("color: blue;" "border-style: solid;")
        self.inform_Car.setStyleSheet("color: green;" "border-style: solid;")
        self.inform_Server.setStyleSheet("color: blue;" "border-style: solid;")
    ...
    def stop_threads(self):
        ...
        if hasattr(self, 'thread_Server') and self.thread_Server.isRunning():
    ...
    def update_server_image(self, cv_img):
        qt_img = self.convert_cv_qt(cv_img)
        self.Server_label.setPixmap(qt_img)
